...
- **cactus-rt / Linux real-time / PREEMPT_RT / RT thread / cyclic loop** -> `cactus-rt`
...
| `cactus-rt` | Building deterministic real-time C++ threads with cactus-rt on PREEMPT_RT Linux, integrated with ROS 2 | cactus-rt, real-time, PREEMPT_RT, cyclic thread, mlockall, SCHED_FIFO, RT loop, PI mutex |
